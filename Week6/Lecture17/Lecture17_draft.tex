...
\includegraphics[width=\textwidth]{\chp5@path/5-2_ci_prop/figures/spear}
\column{0.5\textwidth}
{\small
We can throw a spear where we saw a fish but we will probably miss. If we toss a net in that area, we have a good chance of catching the fish.
}
\column{0.25\textwidth}
\includegraphics[width=\textwidth]{\chp5@path/5-2_ci_prop/figures/net}
\end{columns}
$\:$ \\
...
\section{Board work: derivation of interval with target level}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{\chp5@path/5-2_ci_prop/figures/garfield}
\end{center}
...
\soln{\only<2>{
\begin{center}
\includegraphics[width=0.7\textwidth]{\chp5@path/5-2_ci_prop/figures/middle98/middle98}
\end{center}
}}
