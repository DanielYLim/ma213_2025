...
5.  Using `my_sample()` function, show the probability mass function (pmf) of the sampling distribution of the statistic. Change `n` from 10 to 1000. What do you conclude?
