...
You are given a hypothetical population. Each group will work with a different population. Your goal is to examine how the sample mean,

$$
\hat{\mu} = \frac{1}{n} \sum_{i=1}^{n}x_i
$$ where $x_i$ (for $i=1,2, \dots, n$) are independent samples drawn from the population, is distributed when sampling from your chosen population.

Sample $n= 500$ from your chosen population and the population parameters are given here.
...
1.  Obtain a sample of size $n$ from the population. (You can have arbitrary sample sizes `n=10, 50, 100` )
...
2.  Using the above population, obtain a sample of size $n=100$ from the population and repeat the sampling process $K=100$ times.
