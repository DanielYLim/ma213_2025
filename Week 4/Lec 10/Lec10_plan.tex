...
=======
\end{frame}
>>>>>>> Updated lesson plan formatting
=======
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO: Copy and adapt these slides base on the lesson plan
\input{../../Chp 3/3-5_continuous_distributions/3-5_continuous_distributions.tex}
\input{../../Chp 4/4-1_normal_distribution/4-1_normal_distribution.tex}
>>>>>>> Added input for which slides to adapt
