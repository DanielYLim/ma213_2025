...
#### Let’s roll a die! You are playing a dice-rolling game, and you’re curious about how the game plays out in the end. The rule is that you roll the die once, and the other player rolls it once as well, then you add the outcomes together. What can you expect from this game in the end? What is the long-term average and dispersion of the game results? In other words, what are the expected value and variance?
