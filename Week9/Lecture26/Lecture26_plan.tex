...
\begin{frame}
    ...
    \begin{itemize}
        ...
        % Consider making the confidence interval part into a think/pair/share, or at least breaking it up into subparts
...
% ES: Agreed -- I like how it looks here, where we ask them to figure it out before showing them the answer. But we shouldn't 
% leave out the slides entirely, we just need to highlight the aspects that are different.
% Let's add an activity at the end where we challenge them to think about the similarities/differences between the cases
